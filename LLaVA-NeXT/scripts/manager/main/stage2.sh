...
# Log Path and Rank
RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-stage2-fix"
...
PREV_STAGE_CHECKPOINT="${CHECKPOINT_DIR}/llavanext-google_siglip-so400m-patch14-384-Qwen_Qwen2-0.5B-Instruct-mlp2x_gelu-stage1.5" # replace it with your last checkpoint training from mid stage
