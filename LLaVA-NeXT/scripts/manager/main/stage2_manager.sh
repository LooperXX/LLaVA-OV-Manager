...
# Log Path and Rank
RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-stage2-fix-manager"
...
PREV_STAGE_CHECKPOINT="${CHECKPOINT_DIR}/llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-stage1.5-manager" # replace it with your last checkpoint training from mid stage
